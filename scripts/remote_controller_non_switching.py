...
class JoyStickDevice:
    ...
    def __init__(self, name, ambf_client):
        joy_str = name + 'joy'
        ...
        self._rover_handle = ambf_client.get_obj_handle('Rover')
        self._arm_handle = ambf_client.get_obj_handle('arm_link1')
...
def main():
    ...
    joystick_one = JoyStickDevice(parsed_args.joystick_name, client)
